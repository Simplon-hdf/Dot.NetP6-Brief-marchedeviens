...
{
    public class ContenuPublieRepository : IRepository<ContenuPublie, int>
    {
        ...
        public async Task<bool> Add(ContenuPublie model)
        {
            ...
            int id = model.IdContenuPublie;                                                    // stock l'id du model dans une variable    
